class MoveAdminNotesToComments < ActiveRecord::Migration
  def self.up
    ...
    say "Updating any existing comments to the "+
      "#{ActiveAdmin.application.default_namespace} namespace."
    comments_table_name = ActiveRecord::Migrator.proper_table_name(
      "active_admin_comments")
    execute "UPDATE #{comments_table_name} SET namespace="+
